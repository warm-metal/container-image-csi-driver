...
export REGISTRAR_IMAGE=docker.io/warmmetal/csi-node-driver-registrar
export LIVENESSPROBE_IMAGE=docker.io/warmmetal/livenessprobe
export PROVISIONER_IMAGE=docker.io/warmmetal/csi-provisioner
export VALUE_FILE=$(dirname "${BASH_SOURCE[0]}")/../../charts/warm-metal-csi-driver/values-crio.yaml
