...
minikube ssh -p csi-image-test -- sudo podman pull docker.io/warmmetal/container-image-csi-driver-test:simple-fs
minikube ssh -p csi-image-test -- sudo podman image tag docker.io/warmmetal/container-image-csi-driver-test:simple-fs localhost:31000/warmmetal/csi-image-test:simple-fs
